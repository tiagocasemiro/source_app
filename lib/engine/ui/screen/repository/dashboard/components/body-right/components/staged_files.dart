            ...
            builder: (context, snapshotGitOutput) {
              ...
              return Container(
                ...
                child: Visibility(
                  ...
                  replacement: Center(child: Text("No file to remove",
                  ...
                  child: ListView.builder(
                    itemBuilder: (context, index) {
                      ...
                      return ItemLineCheck(file, index, "Staged files", (String checkedFile) {
                        _bodyRightViewModel.remove(checkedFile).then((GitOutput gitOutput) {
                          if(gitOutput.isFailure()) {
                            GitOutputErrorAlert(context).displayAlert(gitOutput.message);
                          }
                        });
                      }, (String clickedFile) {
                        GitFileModified fileModified = GitFileModified(clickedFile, stageFile: StageFile.staged);
